...
_MODULE_NAME = "pypi_downloads"
_PACKAGE_NAME = 'pypi_downloads'
...
setup(
    ...
    package_data={
        package_name: ['*.yaml', '*.yml', '*.json', '*.png', '*.parquet']
    ...
    url='https://github.com/hansbug/pypi_downloads',
    ...
    entry_points={
        'console_scripts': [
            'pypi_downloads=pypi_downloads.entry:pypi_downloadscli'
        ]
    },
    project_urls={
        'Bug Reports': 'https://github.com/hansbug/pypi_downloads/issues',
        'Source': 'https://github.com/hansbug/pypi_downloads',
        'Documentation': 'https://pypi_downloads.hansbug.org/',
    },
)
